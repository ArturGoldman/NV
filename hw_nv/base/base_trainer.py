...
class BaseTrainer:
    ...
    def __init__(self, Generator, MSD, MPD, optimizer_g, optimiser_d,
                 lr_scheduler_g, lr_scheduler_d, config, device):
        self.device = device
        self.config = config
    ...
    def _train_process(self):
        ...
        for epoch in range(self.start_epoch, self.epochs + 1):
            ...
            # result is expected to have fields:
            # loss
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        if (
            ...
            self.lr_scheduler_g.load_state_dict(checkpoint["scheduler_g"])
            self.optimizer_d.load_state_dict(checkpoint["optimizer_d"])
            self.lr_scheduler_d.load_state_dict(checkpoint["scheduler_d"])
